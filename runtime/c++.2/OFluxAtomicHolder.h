...
public:
	...
	inline int compare(const HeldAtomic & ha) const
		{ 
			...
			return (gt1 == gt2 ? _flow_guard->compare_keys(_key,ha._key)
					: (gt1 < gt2 ? -1 : 1)); 
		}
...
//
#define MAX_ATOMICS_PER_NODE 10
...
public:
	 ...
	 */
	int acquire( AtomicsHolder & given_atomics, const void * node_in );
	/**
